...
(function(){
  var API_KEY='REVENUECAT_IOS_API_KEY_PLAYER';
  var ENTITLEMENT='pro';
  ...
  document.addEventListener('DOMContentLoaded', function(){
    setTimeout(function(){
      window.__iap.entitledNow().then(function(ok){
        ...
        try{
          if(ok && typeof DB!=='undefined' && !DB.officePro && typeof officeUnlocked==='function' && 'player'==='office'){ officeUnlocked(); }
          if(ok && typeof DB!=='undefined' && !DB.pro && typeof setPro==='function' && 'player'==='player'){ setPro(true); }
          if(!ok && typeof DB!=='undefined' && 'player'==='office' && DB.officePro){ DB.officePro=false; save(); if(typeof officeGateCheck==='function') officeGateCheck(); }
          if(!ok && typeof DB!=='undefined' && 'player'==='player' && DB.pro){ setPro(false); }
        }catch(e){}
      });
    }, 800);
  });
